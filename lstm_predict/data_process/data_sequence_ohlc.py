...
class DataSequence:
    ...
    def data_forward(self, data_list, data_index):
        ...
        label_data_array = np.zeros([self.batch_size, 1, 4])
        for i in range(self.batch_size):
            ...
            current_data_list.extend(data_list[data_index][:-4])
            ...
            label_data_array[i,:,0] = data_list[data_index][-4]
            label_data_array[i,:,1] = data_list[data_index][-3]
            label_data_array[i,:,2] = data_list[data_index][-2]
            label_data_array[i,:,3] = data_list[data_index][-1]
            data_index += 1
        # print(current_data_array.shape, current_label_array.shape)
        return traing_data_array, label_data_array, data_index
